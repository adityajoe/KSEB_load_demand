...
st.write("Missing values in rainfall", rainfall_missing)
st.write("Missing values in Relative Humidity ", humidity_missing)
st.write("Missing values in Temperature", temperature_missing)
st.write("Missing values in Radiation value", radiation_missing)
